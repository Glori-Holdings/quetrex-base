# Fixture captured from `git show 80b7895:.claude/lib/cloud-build-routine.md` on branch feature/task-build-cloud-or-local (PR #145),
...
# source path: .claude/lib/cloud-build-routine.md -- content begins at line 4, byte-identical to the git show output.
