...
Tracker status updates are handled at the project level (quetrex-kanban integration, forthcoming). This agent does not touch any tracker — its terminus is an open PR awaiting human merge.
