...
Read `~/.claude/CLAUDE.md` for project context and conventions before any implementation.
...
Both must pass with zero errors and zero warnings before marking any task complete.
