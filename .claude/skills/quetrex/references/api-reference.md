# Quetrex Cloud API Reference

Detailed reference for the Quetrex Cloud control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Quetrex Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "quetrex-mobile",
    "cwd": "/Users/me/quetrex-mobile",
    "repoUrl": "https://github.com/acme/quetrex-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `quetrex-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
...
- `QUETREX_APPROVAL_ID`
- `QUETREX_APPROVAL_STATUS`
- `QUETREX_LINKED_ISSUE_IDS`
